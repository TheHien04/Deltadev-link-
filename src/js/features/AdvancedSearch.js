...
import { levenshteinDistance, stringSimilarity, foldVietnamese } from '../utils/string.js';
...
export class AdvancedSearch {
  ...
  init() {
    ...
    logger.info('[AdvancedSearch]', 'Initialized with', this.products.length, 'products');
  }
  ...
  calculateSimilarity(str1, str2) {
    return stringSimilarity(foldVietnamese(str1), foldVietnamese(str2));
  }
